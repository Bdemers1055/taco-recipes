...
class Condiments extends Component {
  ...
  fetchCondimentRecipe() {
    ...
    const condiment = `/sinker/tacofancy/master/condiments/${
      match.params.condiment
    }`;
...
class Baselayers extends Component {
  ...
  fetchBaseLayerRecipe() {
    const { match } = this.props;
    const baselayer = `/sinker/tacofancy/master/base_layers/${
      match.params.baselayer
    }`;
      ...
      <div>
        <header className="header">
          ...
          <button
            ...
            onClick={this.fetchRandomTacoRecipe.bind(this)}
          >
            <h1>TACO ME</h1>
          </button>
        </header>
    ...
    return (
      <div className="app">
        <section className="recipe">
          ...
          <Route
            path={`${process.env.PUBLIC_URL}//mixins/:mixin`}
            component={Mixins}
          />
          <Route
            path={`${process.env.PUBLIC_URL}//base_layers/:baselayer`}
            component={Baselayers}
          />
          <Route
            path={`${process.env.PUBLIC_URL}//condiments/:condiment`}
